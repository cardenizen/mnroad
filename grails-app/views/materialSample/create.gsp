                            ...
                            <tbody>
                              ...
                              <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:materialSampleInstance,field:'comments','errors')}">
                                  <input type="text" size="60" maxlength="250" id="comments" name="comments" value="${fieldValue(bean:materialSampleInstance,field:'comments')}"/>
                                </td>
                              </tr>
                              ...
                              <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:materialSampleInstance,field:'contactPerson','errors')}">
                                  <input type="text" maxlength="24" id="contactPerson" name="contactPerson" value="${fieldValue(bean:materialSampleInstance,field:'contactPerson')}"/>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                            ...
                            <tbody>
                              ...
                              <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:materialSampleInstance,field:'depthCode','errors')}">
                                  <input type="text" maxlength="40" id="depthCode" name="depthCode" value="${fieldValue(bean:materialSampleInstance,field:'depthCode')}"/>
                                </td>
                              </tr>
