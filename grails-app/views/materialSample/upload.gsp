...
<html>
  ...
  %{--${params}--}%
    <div class="nav">
      ...
      <span class="menuButton"><g:link class="create" action="selectTable">Download MAT_*_TEST Table</g:link></span>
    </div>
  %{--<div class="message">${flash.message}</div>--}%
    <g:if test="${flash.messages}">
      <ul class="message">
      <g:if test="${flash.messages.size()==1}">
        <li>${flash.messages.toArray()[0]}</li>        
      </g:if>
      <g:else>
    ...
    <g:form controller="materialSample" method="post" action="validate" enctype="multipart/form-data">
