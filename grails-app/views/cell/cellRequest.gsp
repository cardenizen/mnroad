  ...
  <g:form style='width:600px;' method="post">
      <table>
        ...
        <tr>
          <td>
            <div id="modelDiv">
              <g:render template="modelsForChosenCell" model="['yearList':yearList, 'modelListFromSensor':modelListFromSensor, 'modelListFromTables':modelListFromTables, 'selcell':cell]"/>
            </div>
          </td>
        </tr>
      </table>
