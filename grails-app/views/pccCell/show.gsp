...
<html>
                    ...
                    <td>
                      <table>
                        <tbody>
                          ...
                          <tr class="prop">
                            <td valign="top" class="name">Tie Bars:</td>
                            <td valign="top" class="value">${fieldValue(bean:cell, field:'tiebars')}</td>
                          </tr>
                        ...
                        <tr class="prop">
                          <td valign="top" class="name">Longitudinal Joint Seal Type:</td>
                          <td valign="top" class="value">${fieldValue(bean:cell, field:'longitudinalJointSeal')}</td>
                        </tr>
                        <tr class="prop">
    ...
    <g:javascript>
     function respondToSelect(val)
     {
         var parms = 'id=${cell.id}&selectedValue='+val;
           new Ajax.Updater("pathSelectDiv",
              "/mnroad/cell/updateSelect",
