...
<%--
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="subgradeResistance">Subgrade R-Vallue:</label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="asphaltBinder">Asphalt Binder:</label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean:cell,field:'asphaltBinder','errors')}">
                                    <input type="text" id="asphaltBinder" name="asphaltBinder" value="${fieldValue(bean:cell,field:'asphaltBinder')}"/>
                                </td>
                            </tr> 
--%>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="hmaDesign">HMA Mix Description:</label>
                                </td>
                          ...
                          <tr class="prop">
                              <td valign="top" class="name">
                                  <label for="mndotMixSpecification">MnDOT Mix Specification:</label>
                              </td>
                              <td valign="top" class="">
