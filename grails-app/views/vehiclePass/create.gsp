                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <td>
                              <input size="120" type="file" name="file_1"/> <g:if test="${vr['file_1']}">${vr['file_1']}</g:if><br/>
                              <input size="120" type="file" name="file_2"/> <g:if test="${vr['file_2']}">${vr['file_2']}</g:if><br/>
                              <input size="120" type="file" name="file_3"/> <g:if test="${vr['file_3']}">${vr['file_3']}</g:if><br/>
                              <input size="120" type="file" name="file_4"/> <g:if test="${vr['file_4']}">${vr['file_4']}</g:if><br/>
                              <input size="120" type="file" name="file_5"/> <g:if test="${vr['file_5']}">${vr['file_5']}</g:if><br/>
                              <g:actionSubmit value="Upload/Validate" action="upload"/>
                            </td>
                            </tr>
